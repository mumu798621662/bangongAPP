    ...
    <el-table
        ...
        <el-table-column
            ...
            <template slot-scope="scope" >
                <img :src="'http://localhost:8888/'+scope.row.photo" alt="" style="width: 100px" >
            </template>
        </el-table-column>
        <el-table-column
                prop="rname"
        ...
        <el-table-column
            ...
            <template slot-scope="scope">
                ...
                <el-button @click="updatePass(scope.row)" type="success" size="small" v-show="isShowEditBtn">编辑</el-button>
            </template>
        </el-table-column>
...
export default {
    ...
    methods:{
        updatePass(data){
            this.$store.commit("setPass",data)
        ...
        del(data){
            ...
            this.$confirm('此操作将永久删除该内容, 是否继续?', '提示', {
                ...
                fetch('/api/deladmin?aid='+data.aid).then((e)=>{
                    return e.text()
                }).then((e)=>{
                    if(e=='ok'){
                        this.tableData = this.tableData.filter((e)=>{
                            return e.aid!=data.aid;
                        })
                        this.$message({
                            message: '恭喜你，删除成功',
                            type: 'success'
